...
public class Util {
	public static final Color DARK_BLUE = Color.black;
	public static final Color ERROR_MESSAGE_COLOR = Color.red; //dark red
	public static final Color INFO_MESSAGE_COLOR = Color.blue; //dark green
	public static final Color LINK_AVAILABLE = Color.white;
